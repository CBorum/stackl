            ...
            <div className="container">
                <div className="row">
                    <div className="col-sm pt-3">
                        ...
                        <button className="btn btn-primary btn-block mx-auto mw-300" onClick={displayLoginModal} >Login</button>
                        <button className="btn btn-primary btn-block mx-auto mw-300" onClick={displayRegisterModal} >Register</button>
                    </div>
                </div>
            </div>
        </div>
